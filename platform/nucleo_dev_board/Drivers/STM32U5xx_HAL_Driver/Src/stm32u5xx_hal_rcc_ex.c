...
#define RCC_EXTI_LINE_MSIPLLUNLCK                                                                                      \
    EXTI_IMR1_IM23 /*!< External interrupt line 23 connected to the MSI PLL UNLOCK interrupt Line */
...
void HAL_RCCEx_GetPeriphCLKConfig(RCC_PeriphCLKInitTypeDef *pPeriphClkInit)
{
    ...
    pPeriphClkInit->PeriphClockSelection =
        ...
        RCC_PERIPHCLK_LPTIM34 | RCC_PERIPHCLK_LPTIM2 | RCC_PERIPHCLK_SAI1 | RCC_PERIPHCLK_SAI2 | RCC_PERIPHCLK_ADCDAC |
        RCC_PERIPHCLK_MDF1 | RCC_PERIPHCLK_ADF1 | RCC_PERIPHCLK_RTC | RCC_PERIPHCLK_ICLK | RCC_PERIPHCLK_SDMMC |
        RCC_PERIPHCLK_RNG | RCC_PERIPHCLK_I2C4 | RCC_PERIPHCLK_SPI1 | RCC_PERIPHCLK_SPI2 | RCC_PERIPHCLK_SPI3 |
    ...
    pPeriphClkInit->PeriphClockSelection =
        ...
        RCC_PERIPHCLK_LPUART1 | RCC_PERIPHCLK_I2C1 | RCC_PERIPHCLK_I2C2 | RCC_PERIPHCLK_I2C3 | RCC_PERIPHCLK_LPTIM1 |
        RCC_PERIPHCLK_LPTIM34 | RCC_PERIPHCLK_LPTIM2 | RCC_PERIPHCLK_SAI1 | RCC_PERIPHCLK_ADCDAC | RCC_PERIPHCLK_MDF1 |
        RCC_PERIPHCLK_ADF1 | RCC_PERIPHCLK_RTC | RCC_PERIPHCLK_ICLK | RCC_PERIPHCLK_SDMMC | RCC_PERIPHCLK_RNG |
...
void HAL_RCCEx_GetPLL1ClockFreq(PLL1_ClocksTypeDef *PLL1_Clocks)
{
    ...
    fracn1 =
        (float_t)(uint32_t)(pll1fracen * ((RCC->PLL1FRACR & RCC_PLL1FRACR_PLL1FRACN) >> RCC_PLL1FRACR_PLL1FRACN_Pos));
    ...
    case RCC_PLLSOURCE_HSI: /* HSI used as PLL clock source */
        pll1vco = ((float_t)HSI_VALUE / (float_t)pll1m) *
                  ((float_t)(uint32_t)(RCC->PLL1DIVR & RCC_PLL1DIVR_PLL1N) + (fracn1 / (float_t)0x2000) + (float_t)1);
        break;
    ...
    if (__HAL_RCC_GET_PLLCLKOUT_CONFIG(RCC_PLL1_DIVP) != 0U)
    {
        PLL1_Clocks->PLL1_P_Frequency =
            (uint32_t)(float_t)(pll1vco /
                                ((float_t)(uint32_t)((RCC->PLL1DIVR & RCC_PLL1DIVR_PLL1P) >> RCC_PLL1DIVR_PLL1P_Pos) +
                                 (float_t)1));
    }
    else
    {
    ...
    if (__HAL_RCC_GET_PLLCLKOUT_CONFIG(RCC_PLL1_DIVQ) != 0U)
    {
        PLL1_Clocks->PLL1_Q_Frequency =
            (uint32_t)(float_t)(pll1vco /
                                ((float_t)(uint32_t)((RCC->PLL1DIVR & RCC_PLL1DIVR_PLL1Q) >> RCC_PLL1DIVR_PLL1Q_Pos) +
                                 (float_t)1));
    }
    else
    {
    ...
    if (__HAL_RCC_GET_PLLCLKOUT_CONFIG(RCC_PLL1_DIVR) != 0U)
    {
        PLL1_Clocks->PLL1_R_Frequency =
            (uint32_t)(float_t)(pll1vco /
                                ((float_t)(uint32_t)((RCC->PLL1DIVR & RCC_PLL1DIVR_PLL1R) >> RCC_PLL1DIVR_PLL1R_Pos) +
                                 (float_t)1));
    }
    else
    {
...
void HAL_RCCEx_GetPLL2ClockFreq(PLL2_ClocksTypeDef *PLL2_Clocks)
{
    ...
    case RCC_PLLSOURCE_HSI: /* HSI used as PLL clock source */
        pll2vco = ((float_t)HSI_VALUE / (float_t)pll2m) *
                  ((float_t)(uint32_t)(RCC->PLL2DIVR & RCC_PLL2DIVR_PLL2N) + (fracn2 / (float_t)0x2000) + (float_t)1);
        break;
    ...
    if (__HAL_RCC_GET_PLL2CLKOUT_CONFIG(RCC_PLL2_DIVP) != 0U)
    {
        PLL2_Clocks->PLL2_P_Frequency =
            (uint32_t)(float_t)(pll2vco /
                                ((float_t)(uint32_t)((RCC->PLL2DIVR & RCC_PLL2DIVR_PLL2P) >> RCC_PLL2DIVR_PLL2P_Pos) +
                                 (float_t)1));
    }
    else
    {
    ...
    if (__HAL_RCC_GET_PLL2CLKOUT_CONFIG(RCC_PLL2_DIVQ) != 0U)
    {
        PLL2_Clocks->PLL2_Q_Frequency =
            (uint32_t)(float_t)(pll2vco /
                                ((float_t)(uint32_t)((RCC->PLL2DIVR & RCC_PLL2DIVR_PLL2Q) >> RCC_PLL2DIVR_PLL2Q_Pos) +
                                 (float_t)1));
    }
    else
    {
    ...
    if (__HAL_RCC_GET_PLL2CLKOUT_CONFIG(RCC_PLL2_DIVR) != 0U)
    {
        PLL2_Clocks->PLL2_R_Frequency =
            (uint32_t)(float_t)(pll2vco /
                                ((float_t)(uint32_t)((RCC->PLL2DIVR & RCC_PLL2DIVR_PLL2R) >> RCC_PLL2DIVR_PLL2R_Pos) +
                                 (float_t)1));
    }
    else
    {
...
void HAL_RCCEx_GetPLL3ClockFreq(PLL3_ClocksTypeDef *PLL3_Clocks)
{
    ...
    */
    ...
    fracn3 =
        (float_t)(uint32_t)(pll3fracen * ((RCC->PLL3FRACR & RCC_PLL3FRACR_PLL3FRACN) >> RCC_PLL3FRACR_PLL3FRACN_Pos));

    switch (pll3source)
    {
    case RCC_PLLSOURCE_HSI: /* HSI used as PLL clock source */
        pll3vco = ((float_t)HSI_VALUE / (float_t)pll3m) *
                  ((float_t)(uint32_t)(RCC->PLL3DIVR & RCC_PLL3DIVR_PLL3N) + (fracn3 / (float_t)0x2000) + (float_t)1);
    ...
    if (__HAL_RCC_GET_PLL3CLKOUT_CONFIG(RCC_PLL3_DIVP) != 0U)
    {
        PLL3_Clocks->PLL3_P_Frequency =
            (uint32_t)(float_t)(pll3vco /
                                ((float_t)(uint32_t)((RCC->PLL3DIVR & RCC_PLL3DIVR_PLL3P) >> RCC_PLL3DIVR_PLL3P_Pos) +
                                 (float_t)1));
    }
    else
    {
    ...
    if (__HAL_RCC_GET_PLL3CLKOUT_CONFIG(RCC_PLL3_DIVQ) != 0U)
    {
        PLL3_Clocks->PLL3_Q_Frequency =
            (uint32_t)(float_t)(pll3vco /
                                ((float_t)(uint32_t)((RCC->PLL3DIVR & RCC_PLL3DIVR_PLL3Q) >> RCC_PLL3DIVR_PLL3Q_Pos) +
                                 (float_t)1));
    }
    else
    {
    ...
    if (__HAL_RCC_GET_PLL3CLKOUT_CONFIG(RCC_PLL3_DIVR) != 0U)
    {
        PLL3_Clocks->PLL3_R_Frequency =
            (uint32_t)(float_t)(pll3vco /
                                ((float_t)(uint32_t)((RCC->PLL3DIVR & RCC_PLL3DIVR_PLL3R) >> RCC_PLL3DIVR_PLL3R_Pos) +
                                 (float_t)1));
    }
    else
    {
...
void HAL_RCCEx_LSECSS_IRQHandler(void)
{
    ...
    if (READ_BIT(RCC->BDCR, RCC_BDCR_LSECSSD) != 0U)
    {
        ...
        if ((falling_edge_flag == RCC_EXTI_LINE_LSECSS) || (rising_edge_flag == RCC_EXTI_LINE_LSECSS))
        {
...
void HAL_RCCEx_MSIPLLUNLCK_IRQHandler(void)
{
    ...
    if ((rising_edge_flag == RCC_EXTI_LINE_MSIPLLUNLCK) || (falling_edge_flag == RCC_EXTI_LINE_MSIPLLUNLCK))
    {
...
static HAL_StatusTypeDef RCCEx_PLL2_Config(const RCC_PLL2InitTypeDef *pll2)
{
    ...
    __HAL_RCC_PLL2_CONFIG(pll2->PLL2Source, pll2->PLL2M, pll2->PLL2N, pll2->PLL2P, pll2->PLL2Q, pll2->PLL2R);
...
static HAL_StatusTypeDef RCCEx_PLL3_Config(const RCC_PLL3InitTypeDef *pll3)
{
    ...
    __HAL_RCC_PLL3_CONFIG(pll3->PLL3Source, pll3->PLL3M, pll3->PLL3N, pll3->PLL3P, pll3->PLL3Q, pll3->PLL3R);
