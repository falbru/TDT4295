                                                     ...
                                                     const UART_AutonomousModeConfTypeDef *sConfig)
{
    ...
    if (huart->gState == HAL_UART_STATE_READY)
    {
        ...
        tmpreg =
            ((sConfig->DataSize << USART_AUTOCR_TDN_Pos) | (sConfig->TriggerPolarity) | (sConfig->AutonomousModeState) |
             (sConfig->IdleFrame) | (sConfig->TriggerSelection << USART_AUTOCR_TRIGSEL_Pos));
