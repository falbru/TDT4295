...
#define LL_MPU_CTRL_HFNMI_PRIVDEF_NONE                                                                                 \
    0U /*!< Background region access not allowed, MPU disabled for Hardfaults, NMIs, and exception handlers when       \
          FAULTMASK=1 */
#define LL_MPU_CTRL_HARDFAULT_NMI                                                                                      \
    2U /*!< Background region access not allowed, MPU enabled for Hardfaults, NMIs, and exception handlers when        \
          FAULTMASK=1 */
#define LL_MPU_CTRL_PRIVILEGED_DEFAULT                                                                                 \
    4U /*!< Background region privileged-only access allowed, MPU disabled for Hardfaults, NMIs, and exception         \
          handlers when FAULTMASK=1 */
#define LL_MPU_CTRL_HFNMI_PRIVDEF                                                                                      \
    6U /*!< Background region privileged-only access allowed, MPU enabled for Hardfaults, NMIs, and exception handlers \
          when FAULTMASK=1 */
/**
 * @}
 */
...
#define LL_MPU_ATTRIBUTES_NUMBER7 7U
     ...
     * @retval None
     */
    __STATIC_INLINE void LL_MPU_ConfigRegion(uint32_t Region, uint32_t Attributes, uint32_t AttrIndx,
