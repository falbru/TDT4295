...
#define SYSCFG_OTG_HS_PHY_POWER_DOWN                                                                                   \
    SYSCFG_OTGHSPHYCR_PDCTRL /*!< PHY state machine, bias and OTG PHY PLL remain powered */
...
#define IS_SYSCFG_LOCK_ITEMS(__ITEM__)                                                                                 \
    ((((__ITEM__) & SYSCFG_MPU_NSEC) == SYSCFG_MPU_NSEC) || (((__ITEM__) & SYSCFG_VTOR_NSEC) == SYSCFG_VTOR_NSEC) ||   \
     (((__ITEM__) & SYSCFG_SAU) == SYSCFG_SAU) || (((__ITEM__) & SYSCFG_MPU_SEC) == SYSCFG_MPU_SEC) ||                 \
...
#define IS_SYSCFG_OTGPHY_DISCONNECT(__VALUE__)                                                                         \
    (((__VALUE__) == SYSCFG_OTG_HS_PHY_DISCONNECT_5_9PERCENT) || ((__VALUE__) == SYSCFG_OTG_HS_PHY_DISCONNECT_0PERCENT))
