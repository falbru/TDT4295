...
#include "stm32u5xx_hal_def.h"
    ...
    typedef struct
    {
        ...
        uint32_t BreakFilter; /*!< Specifies the break input filter.This parameter can be a number between Min_Data =
                                 0x0 and Max_Data = 0xF */

        uint32_t BreakAFMode; /*!< Specifies the alternate function mode of the break input.This parameter can be a
                                 value of @ref TIM_Break_Input_AF_Mode */
        ...
        uint32_t Break2AFMode; /*!< Specifies the alternate function mode of the break2 input.This parameter can be a
                                  value of @ref TIM_Break2_Input_AF_Mode */
...
#define TIM_ENCODERMODE_CLOCKPLUSDIRECTION_X1                                                                          \
    (TIM_SMCR_SMS_3 | TIM_SMCR_SMS_1 |                                                                                 \
     TIM_SMCR_SMS_0) /*!< Encoder mode: Clock plus direction, x1 mode, TI2FP2 edge sensitivity is set by CC2P */
...
#define TIM_ENCODERMODE_DIRECTIONALCLOCK_X1_TI12                                                                       \
    (TIM_SMCR_SMS_3 | TIM_SMCR_SMS_2 | TIM_SMCR_SMS_0) /*!< Encoder mode: Directional Clock, x1 mode, TI1FP1 and       \
                                                          TI2FP2 edge sensitivity is set by CC1P and CC2P */
#define TIM_ENCODERMODE_X1_TI1                                                                                         \
    (TIM_SMCR_SMS_3 | TIM_SMCR_SMS_2 | TIM_SMCR_SMS_1) /*!< Quadrature encoder mode: x1 mode, counting on TI1FP1 edges \
                                                          only, edge sensitivity is set by CC1P */
#define TIM_ENCODERMODE_X1_TI2                                                                                         \
    (TIM_SMCR_SMS_3 | TIM_SMCR_SMS_2 | TIM_SMCR_SMS_1 |                                                                \
     TIM_SMCR_SMS_0) /*!< Quadrature encoder mode: x1 mode, counting on TI2FP2 edges only, edge sensitivity is set by  \
                        CC1P */
/**
 * @}
 */
...
#define TIM_BREAK_SYSTEM_PVD                                                                                           \
    SYSCFG_CFGR2_PVDL /*!< Enables and locks the PVD connection with TIM1/8/15/16/17/20 Break Input and also the PVDE  \
...
#define IS_TIM_DMA_BASE(__BASE__)                                                                                      \
    (((__BASE__) == TIM_DMABASE_CR1) || ((__BASE__) == TIM_DMABASE_CR2) || ((__BASE__) == TIM_DMABASE_SMCR) ||         \
     ...
     ((__BASE__) == TIM_DMABASE_DTR2) || ((__BASE__) == TIM_DMABASE_ECR) || ((__BASE__) == TIM_DMABASE_OR1))
...
#define IS_TIM_ENCODER_MODE(__MODE__)                                                                                  \
    (((__MODE__) == TIM_ENCODERMODE_TI1) || ((__MODE__) == TIM_ENCODERMODE_TI2) ||                                     \
     ...
     ((__MODE__) == TIM_ENCODERMODE_CLOCKPLUSDIRECTION_X1) || ((__MODE__) == TIM_ENCODERMODE_DIRECTIONALCLOCK_X2) ||   \
...
#define IS_TIM_TRGO_SOURCE(__SOURCE__)                                                                                 \
    (((__SOURCE__) == TIM_TRGO_RESET) || ((__SOURCE__) == TIM_TRGO_ENABLE) || ((__SOURCE__) == TIM_TRGO_UPDATE) ||     \
     ...
     ((__SOURCE__) == TIM_TRGO_OC3REF) || ((__SOURCE__) == TIM_TRGO_OC4REF) || ((__SOURCE__) == TIM_TRGO_ENCODER_CLK))
...
#define IS_TIM_OC_MODE(__MODE__)                                                                                       \
    (((__MODE__) == TIM_OCMODE_TIMING) || ((__MODE__) == TIM_OCMODE_ACTIVE) || ((__MODE__) == TIM_OCMODE_INACTIVE) ||  \
     ...
     ((__MODE__) == TIM_OCMODE_RETRIGERRABLE_OPM2) || ((__MODE__) == TIM_OCMODE_DIRECTION_OUTPUT) ||                   \
