...
#define PWR_PVM_MODE_IT_RISING_FALLING                                                                                 \
    (0x07U)                                /*!< External Interrupt Mode with Rising/Falling edge trigger detection */
...
#define PWR_SRAM1_PAGE1_STOP                                                                                           \
    (SRAM1_ID | PAGE01_ID) /*!< SRAM1 page 1 (64 KB) retention in Stop modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM1_PAGE2_STOP                                                                                           \
    (SRAM1_ID | PAGE02_ID) /*!< SRAM1 page 2 (64 KB) retention in Stop modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM1_PAGE3_STOP                                                                                           \
    (SRAM1_ID | PAGE03_ID) /*!< SRAM1 page 3 (64 KB) retention in Stop modes (Stop 0, 1, 2, 3)    */
#if defined(PWR_CR4_SRAM1PDS4)
#define PWR_SRAM1_PAGE4_STOP                                                                                           \
    (SRAM1_ID | PAGE04_ID) /*!< SRAM1 page 4 (64 KB) retention in Stop modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM1_PAGE5_STOP                                                                                           \
    (SRAM1_ID | PAGE05_ID) /*!< SRAM1 page 5 (64 KB) retention in Stop modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM1_PAGE6_STOP                                                                                           \
    (SRAM1_ID | PAGE06_ID) /*!< SRAM1 page 6 (64 KB) retention in Stop modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM1_PAGE7_STOP                                                                                           \
    (SRAM1_ID | PAGE07_ID) /*!< SRAM1 page 7 (64 KB) retention in Stop modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM1_PAGE8_STOP                                                                                           \
    (SRAM1_ID | PAGE08_ID) /*!< SRAM1 page 8 (64 KB) retention in Stop modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM1_PAGE9_STOP                                                                                           \
    (SRAM1_ID | PAGE09_ID) /*!< SRAM1 page 9 (64 KB) retention in Stop modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM1_PAGE10_STOP                                                                                          \
    (SRAM1_ID | PAGE10_ID) /*!< SRAM1 page 10 (64 KB) retention in Stop modes (Stop 0, 1, 2, 3)   */
#define PWR_SRAM1_PAGE11_STOP                                                                                          \
    (SRAM1_ID | PAGE11_ID) /*!< SRAM1 page 11 (64 KB) retention in Stop modes (Stop 0, 1, 2, 3)   */
#define PWR_SRAM1_PAGE12_STOP                                                                                          \
    (SRAM1_ID | PAGE12_ID) /*!< SRAM1 page 12 (64 KB) retention in Stop modes (Stop 0, 1, 2, 3)   */
#define PWR_SRAM1_FULL_STOP                                                                                            \
    (SRAM1_ID | 0x0FFFU) /*!< SRAM1 all pages retention in Stop modes (Stop 0, 1, 2, 3)         */
#else
...
#define PWR_SRAM2_PAGE1_STOP                                                                                           \
    (SRAM2_ID | PAGE01_ID) /*!< SRAM2 page 1 (8 KB) retention in Stop modes  (Stop 0, 1, 2)       */
#define PWR_SRAM2_PAGE2_STOP                                                                                           \
    (SRAM2_ID | PAGE02_ID)                     /*!< SRAM2 page 2 (54 KB) retention in Stop modes (Stop 0, 1, 2)       */
...
#define PWR_SRAM3_PAGE1_STOP                                                                                           \
    (SRAM3_ID | PAGE01_ID) /*!< SRAM3 page 1 (64 KB) retention in Stop modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM3_PAGE2_STOP                                                                                           \
    (SRAM3_ID | PAGE02_ID) /*!< SRAM3 page 2 (64 KB) retention in Stop modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM3_PAGE3_STOP                                                                                           \
    (SRAM3_ID | PAGE03_ID) /*!< SRAM3 page 3 (64 KB) retention in Stop modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM3_PAGE4_STOP                                                                                           \
    (SRAM3_ID | PAGE04_ID) /*!< SRAM3 page 4 (64 KB) retention in Stop modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM3_PAGE5_STOP                                                                                           \
    (SRAM3_ID | PAGE05_ID) /*!< SRAM3 page 5 (64 KB) retention in Stop modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM3_PAGE6_STOP                                                                                           \
    (SRAM3_ID | PAGE06_ID) /*!< SRAM3 page 6 (64 KB) retention in Stop modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM3_PAGE7_STOP                                                                                           \
    (SRAM3_ID | PAGE07_ID) /*!< SRAM3 page 7 (64 KB) retention in Stop modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM3_PAGE8_STOP                                                                                           \
    (SRAM3_ID | PAGE08_ID) /*!< SRAM3 page 8 (64 KB) retention in Stop modes (Stop 0, 1, 2, 3)    */
#if defined(PWR_CR4_SRAM3PDS9)
#define PWR_SRAM3_PAGE9_STOP                                                                                           \
    (SRAM3_ID | PAGE09_ID) /*!< SRAM3 page 9 (64 KB) retention in Stop modes  (Stop 0, 1, 2, 3)   */
#define PWR_SRAM3_PAGE10_STOP                                                                                          \
    (SRAM3_ID | PAGE10_ID) /*!< SRAM3 page 10 (64 KB) retention in Stop modes (Stop 0, 1, 2, 3)   */
#define PWR_SRAM3_PAGE11_STOP                                                                                          \
    (SRAM3_ID | PAGE11_ID) /*!< SRAM3 page 11 (64 KB) retention in Stop modes (Stop 0, 1, 2, 3)   */
#define PWR_SRAM3_PAGE12_STOP                                                                                          \
    (SRAM3_ID | PAGE12_ID) /*!< SRAM3 page 12 (64 KB) retention in Stop modes (Stop 0, 1, 2, 3)   */
#define PWR_SRAM3_PAGE13_STOP                                                                                          \
    (SRAM3_ID | PAGE13_ID) /*!< SRAM3 page 13 (64 KB) retention in Stop modes (Stop 0, 1, 2, 3)   */
#define PWR_SRAM3_FULL_STOP                                                                                            \
    (SRAM3_ID | 0x1FFFU) /*!< SRAM3 all pages retention in Stop modes       (Stop 0, 1, 2, 3)   */
#else
...
#define PWR_SRAM4_FULL_STOP                                                                                            \
    (SRAM4_ID | PAGE01_ID) /*!< SRAM4 retention in Stop modes (Stop 0, 1, 2, 3)                   */

#if defined(PWR_CR4_SRAM5PDS1)
/* SRAM5 pages retention defines */
#define PWR_SRAM5_PAGE1_STOP                                                                                           \
    (SRAM5_ID | PAGE01_ID) /*!< SRAM5 page 1 (64 KB) retention in Stop modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM5_PAGE2_STOP                                                                                           \
    (SRAM5_ID | PAGE02_ID) /*!< SRAM5 page 2 (64 KB) retention in Stop modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM5_PAGE3_STOP                                                                                           \
    (SRAM5_ID | PAGE03_ID) /*!< SRAM5 page 3 (64 KB) retention in Stop modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM5_PAGE4_STOP                                                                                           \
    (SRAM5_ID | PAGE04_ID) /*!< SRAM5 page 4 (64 KB) retention in Stop modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM5_PAGE5_STOP                                                                                           \
    (SRAM5_ID | PAGE05_ID) /*!< SRAM5 page 5 (64 KB) retention in Stop modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM5_PAGE6_STOP                                                                                           \
    (SRAM5_ID | PAGE06_ID) /*!< SRAM5 page 6 (64 KB) retention in Stop modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM5_PAGE7_STOP                                                                                           \
    (SRAM5_ID | PAGE07_ID) /*!< SRAM5 page 7 (64 KB) retention in Stop modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM5_PAGE8_STOP                                                                                           \
    (SRAM5_ID | PAGE08_ID) /*!< SRAM5 page 8 (64 KB) retention in Stop modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM5_PAGE9_STOP                                                                                           \
    (SRAM5_ID | PAGE09_ID) /*!< SRAM5 page 9 (64 KB) retention in Stop modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM5_PAGE10_STOP                                                                                          \
    (SRAM5_ID | PAGE10_ID) /*!< SRAM5 page 10 (64 KB) retention in Stop modes (Stop 0, 1, 2, 3)   */
#define PWR_SRAM5_PAGE11_STOP                                                                                          \
    (SRAM5_ID | PAGE11_ID) /*!< SRAM5 page 11 (64 KB) retention in Stop modes (Stop 0, 1, 2, 3)   */
#define PWR_SRAM5_PAGE12_STOP                                                                                          \
    (SRAM5_ID | PAGE12_ID) /*!< SRAM5 page 12 (64 KB) retention in Stop modes (Stop 0, 1, 2, 3)   */
#define PWR_SRAM5_PAGE13_STOP                                                                                          \
    (SRAM5_ID | PAGE13_ID) /*!< SRAM5 page 13 (64 KB) retention in Stop modes (Stop 0, 1, 2, 3)   */
#define PWR_SRAM5_FULL_STOP                                                                                            \
    (SRAM5_ID | 0x1FFFU) /*!< SRAM5 all pages retention in Stop modes      (Stop 0, 1, 2, 3)    */
#endif                   /* defined (PWR_CR4_SRAM5PDS1) */

#if defined(PWR_CR5_SRAM6PDS1)
/* SRAM5 pages retention defines */
#define PWR_SRAM6_PAGE1_STOP                                                                                           \
    (SRAM6_ID | PAGE01_ID) /*!< SRAM6 page 1 (64 KB) retention in Stop modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM6_PAGE2_STOP                                                                                           \
    (SRAM6_ID | PAGE02_ID) /*!< SRAM6 page 2 (64 KB) retention in Stop modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM6_PAGE3_STOP                                                                                           \
    (SRAM6_ID | PAGE03_ID) /*!< SRAM6 page 3 (64 KB) retention in Stop modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM6_PAGE4_STOP                                                                                           \
    (SRAM6_ID | PAGE04_ID) /*!< SRAM6 page 4 (64 KB) retention in Stop modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM6_PAGE5_STOP                                                                                           \
    (SRAM6_ID | PAGE05_ID) /*!< SRAM6 page 5 (64 KB) retention in Stop modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM6_PAGE6_STOP                                                                                           \
    (SRAM6_ID | PAGE06_ID) /*!< SRAM6 page 6 (64 KB) retention in Stop modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM6_PAGE7_STOP                                                                                           \
    (SRAM6_ID | PAGE07_ID) /*!< SRAM6 page 7 (64 KB) retention in Stop modes (Stop 0, 1, 2, 3)    */
#define PWR_SRAM6_PAGE8_STOP                                                                                           \
    (SRAM6_ID | PAGE08_ID)                     /*!< SRAM6 page 8 (64 KB) retention in Stop modes (Stop 0, 1, 2, 3)    */
...
#define PWR_ICACHE_FULL_STOP                                                                                           \
    (ICACHERAM_ID | PAGE01_ID) /*!< ICACHE page retention in Stop modes (Stop 0, 1, 2, 3)             */
#define PWR_DCACHE1_FULL_STOP                                                                                          \
    (DCACHE1RAM_ID | PAGE01_ID) /*!< DCACHE1 page retention in Stop modes (Stop 0, 1, 2, 3)            */
#if defined(PWR_CR2_DC2RAMPDS)
#define PWR_DCACHE2_FULL_STOP                                                                                          \
    (DCACHE2RAM_ID | PAGE01_ID) /*!< DCACHE2 page retention in Stop modes (Stop 0, 1, 2, 3)            */
#endif                          /* defined (PWR_CR2_DC2RAMPDS) */

#if defined(PWR_CR2_DMA2DRAMPDS)
/* DMA2D RAM retention defines */
#define PWR_DMA2DRAM_FULL_STOP                                                                                         \
    (DMA2DRAM_ID | PAGE01_ID) /*!< DMA2D RAM retention in Stop modes (Stop 0, 1, 2, 3)               */
#endif                        /* PWR_CR2_DMA2DRAMPDS */

/* FMAC, FDCAN and USB RAMs retention defines */
#define PWR_PERIPHRAM_FULL_STOP                                                                                        \
    (PERIPHRAM_ID | PAGE01_ID) /*!< FMAC, FDCAN and USB RAM retention in Stop modes (Stop 0, 1, 2, 3) */

/* PKA32 RAM retention defines */
#define PWR_PKA32RAM_FULL_STOP                                                                                         \
    (PKARAM_ID | PAGE01_ID) /*!< PKA32 RAM retention in Stop modes (Stop 0, 1, 2, 3)               */

#if defined(PWR_CR2_GPRAMPDS)
/* Graphic peripherals RAM retention defines */
#define PWR_GRAPHICPRAM_FULL_STOP                                                                                      \
    (GRAPHIPRAM_ID | PAGE01_ID) /*!< LTDC, GFXMMU retention in Stop modes (Stop 0, 1, 2, 3)            */
#endif                          /* defined (PWR_CR2_GPRAMPDS) */

#if defined(PWR_CR2_DSIRAMPDS)
/* DSI RAM retention defines */
#define PWR_DSIRAM_FULL_STOP                                                                                           \
    (DSIRAM_ID | PAGE01_ID) /*!< DSI RAM retention in Stop modes (Stop 0, 1, 2, 3)                 */
#endif                      /* defined (PWR_CR2_DSIRAMPDS) */

#if defined(PWR_CR2_JPEGRAMPDS)
/* JPEG RAM retention defines */
#define PWR_JPEGRAM_FULL_STOP                                                                                          \
    (JPEGRAM_ID | PAGE01_ID) /*!< JPEG RAM retention in Stop modes (Stop 0, 1, 2, 3)                 */
...
#define PWR_SRAM2_FULL_STANDBY                                                                                         \
    (PWR_CR1_RRSB1 | PWR_CR1_RRSB2) /*!< SRAM2 all pages retention in Stop 3 and Standby modes      */
/**
 * @}
 */
...
#if defined(PWR_CR1_SRAM6PD)
#define PWR_ALL_RAM_RUN_MASK                                                                                           \
    (PWR_SRAM1_FULL_RUN | PWR_SRAM2_FULL_RUN | PWR_SRAM3_FULL_RUN | PWR_SRAM4_FULL_RUN | PWR_SRAM5_FULL_RUN |          \
     PWR_SRAM6_FULL_RUN)
...
#else
#define PWR_ALL_RAM_RUN_MASK (PWR_SRAM1_FULL_RUN | PWR_SRAM2_FULL_RUN | PWR_SRAM4_FULL_RUN)
#endif /* defined (PWR_CR1_SRAM5PD) */
/**
 * @}
 */
...
#define IS_PWR_PVM_TYPE(TYPE)                                                                                          \
    (((TYPE) == PWR_UVM) || ((TYPE) == PWR_IO2VM) || ((TYPE) == PWR_AVM1) || ((TYPE) == PWR_AVM2))
...
#define IS_PWR_VOLTAGE_SCALING_RANGE(RANGE)                                                                            \
    (((RANGE) == PWR_REGULATOR_VOLTAGE_SCALE1) || ((RANGE) == PWR_REGULATOR_VOLTAGE_SCALE2) ||                         \
     ((RANGE) == PWR_REGULATOR_VOLTAGE_SCALE3) || ((RANGE) == PWR_REGULATOR_VOLTAGE_SCALE4))
...
#define IS_PWR_GPIO_PORT(GPIO_PORT)                                                                                    \
    (((GPIO_PORT) == PWR_GPIO_A) || ((GPIO_PORT) == PWR_GPIO_B) || ((GPIO_PORT) == PWR_GPIO_C) ||                      \
     ((GPIO_PORT) == PWR_GPIO_D) || ((GPIO_PORT) == PWR_GPIO_E) || ((GPIO_PORT) == PWR_GPIO_F) ||                      \
     ((GPIO_PORT) == PWR_GPIO_G) || ((GPIO_PORT) == PWR_GPIO_H) || ((GPIO_PORT) == PWR_GPIO_I) ||                      \
...
#define IS_PWR_GPIO_PORT(GPIO_PORT)                                                                                    \
    (((GPIO_PORT) == PWR_GPIO_A) || ((GPIO_PORT) == PWR_GPIO_B) || ((GPIO_PORT) == PWR_GPIO_C) ||                      \
     ((GPIO_PORT) == PWR_GPIO_D) || ((GPIO_PORT) == PWR_GPIO_E) || ((GPIO_PORT) == PWR_GPIO_G) ||                      \
...
#define IS_PWR_SRAM2_STANDBY_RETENTION(CONTENT)                                                                        \
    (((CONTENT) == PWR_SRAM2_PAGE1_STANDBY) || ((CONTENT) == PWR_SRAM2_PAGE2_STANDBY) ||                               \
