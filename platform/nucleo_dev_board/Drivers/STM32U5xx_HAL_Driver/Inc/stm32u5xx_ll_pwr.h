...
#define LL_PWR_SRAM2_SB_FULL_RETENTION                                                                                 \
    (PWR_CR1_RRSB1 | PWR_CR1_RRSB2) /*!< SRAM2 all pages retention in Stop 3 and Standby mode      */
/**
 * @}
 */
...
#define LL_PWR_SRAM1_STOP_PAGE1_RETENTION                                                                              \
    (PWR_CR2_SRAM1PDS1) /*!< SRAM1 page 1  (64 KB) retention in Stop mode (Stop 0, 1, 2, 3) */
#define LL_PWR_SRAM1_STOP_PAGE2_RETENTION                                                                              \
    (PWR_CR2_SRAM1PDS2) /*!< SRAM1 page 2  (64 KB) retention in Stop mode (Stop 0, 1, 2, 3) */
#define LL_PWR_SRAM1_STOP_PAGE3_RETENTION                                                                              \
    (PWR_CR2_SRAM1PDS3) /*!< SRAM1 page 3  (64 KB) retention in Stop mode (Stop 0, 1, 2, 3) */
#if defined(PWR_CR4_SRAM1PDS4)
#define LL_PWR_SRAM1_STOP_PAGE4_RETENTION                                                                              \
    (PWR_CR4_SRAM1PDS4) /*!< SRAM1 page 4  (64 KB) retention in Stop mode (Stop 0, 1, 2, 3) */
#define LL_PWR_SRAM1_STOP_PAGE5_RETENTION                                                                              \
    (PWR_CR4_SRAM1PDS5) /*!< SRAM1 page 5  (64 KB) retention in Stop mode (Stop 0, 1, 2, 3) */
#define LL_PWR_SRAM1_STOP_PAGE6_RETENTION                                                                              \
    (PWR_CR4_SRAM1PDS6) /*!< SRAM1 page 6  (64 KB) retention in Stop mode (Stop 0, 1, 2, 3) */
#define LL_PWR_SRAM1_STOP_PAGE7_RETENTION                                                                              \
    (PWR_CR4_SRAM1PDS7) /*!< SRAM1 page 7  (64 KB) retention in Stop mode (Stop 0, 1, 2, 3) */
#define LL_PWR_SRAM1_STOP_PAGE8_RETENTION                                                                              \
    (PWR_CR4_SRAM1PDS8) /*!< SRAM1 page 8  (64 KB) retention in Stop mode (Stop 0, 1, 2, 3) */
#define LL_PWR_SRAM1_STOP_PAGE9_RETENTION                                                                              \
    (PWR_CR4_SRAM1PDS9) /*!< SRAM1 page 9  (64 KB) retention in Stop mode (Stop 0, 1, 2, 3) */
#define LL_PWR_SRAM1_STOP_PAGE10_RETENTION                                                                             \
    (PWR_CR4_SRAM1PDS10) /*!< SRAM1 page 10 (64 KB) retention in Stop mode (Stop 0, 1, 2, 3) */
#define LL_PWR_SRAM1_STOP_PAGE11_RETENTION                                                                             \
    (PWR_CR4_SRAM1PDS11) /*!< SRAM1 page 11 (64 KB) retention in Stop mode (Stop 0, 1, 2, 3) */
#define LL_PWR_SRAM1_STOP_PAGE12_RETENTION                                                                             \
    (PWR_CR4_SRAM1PDS12) /*!< SRAM1 page 12 (64 KB) retention in Stop mode (Stop 0, 1, 2, 3) */
...
#define LL_PWR_SRAM2_STOP_PAGE1_RETENTION                                                                              \
    (PWR_CR2_SRAM2PDS1) /*!< SRAM2 page 1 (8 KB) retention in Stop mode  (Stop 0, 1, 2) */
#define LL_PWR_SRAM2_STOP_PAGE2_RETENTION                                                                              \
    (PWR_CR2_SRAM2PDS2) /*!< SRAM2 page 2 (54 KB) retention in Stop mode (Stop 0, 1, 2) */
#define LL_PWR_SRAM2_STOP_FULL_RETENTION                                                                               \
    (PWR_CR2_SRAM2PDS1 | PWR_CR2_SRAM2PDS2) /*!< SRAM2 all pages retention in Stop mode      (Stop 0, 1, 2) */
    /**
     * @}
     */
...
#define LL_PWR_SRAM3_STOP_PAGE1_RETENTION                                                                              \
    (PWR_CR2_SRAM3PDS1) /*!< SRAM3 page 1 (64 KB) retention in Stop mode (Stop 0, 1, 2, 3)   */
#define LL_PWR_SRAM3_STOP_PAGE2_RETENTION                                                                              \
    (PWR_CR2_SRAM3PDS2) /*!< SRAM3 page 2 (64 KB) retention in Stop mode (Stop 0, 1, 2, 3)   */
#define LL_PWR_SRAM3_STOP_PAGE3_RETENTION                                                                              \
    (PWR_CR2_SRAM3PDS3) /*!< SRAM3 page 3 (64 KB) retention in Stop mode (Stop 0, 1, 2, 3)   */
#define LL_PWR_SRAM3_STOP_PAGE4_RETENTION                                                                              \
    (PWR_CR2_SRAM3PDS4) /*!< SRAM3 page 4 (64 KB) retention in Stop mode (Stop 0, 1, 2, 3)   */
#define LL_PWR_SRAM3_STOP_PAGE5_RETENTION                                                                              \
    (PWR_CR2_SRAM3PDS5) /*!< SRAM3 page 5 (64 KB) retention in Stop mode (Stop 0, 1, 2, 3)   */
#define LL_PWR_SRAM3_STOP_PAGE6_RETENTION                                                                              \
    (PWR_CR2_SRAM3PDS6) /*!< SRAM3 page 6 (64 KB) retention in Stop mode (Stop 0, 1, 2, 3)   */
#define LL_PWR_SRAM3_STOP_PAGE7_RETENTION                                                                              \
    (PWR_CR2_SRAM3PDS7) /*!< SRAM3 page 7 (64 KB) retention in Stop mode (Stop 0, 1, 2, 3)   */
#define LL_PWR_SRAM3_STOP_PAGE8_RETENTION                                                                              \
    (PWR_CR2_SRAM3PDS8) /*!< SRAM3 page 8 (64 KB) retention in Stop mode (Stop 0, 1, 2, 3)   */
#if defined(PWR_CR4_SRAM3PDS9)
#define LL_PWR_SRAM3_STOP_PAGE9_RETENTION                                                                              \
    (PWR_CR4_SRAM3PDS9) /*!< SRAM3 page 9 (64 KB) retention in Stop mode (Stop 0, 1, 2, 3)   */
#define LL_PWR_SRAM3_STOP_PAGE10_RETENTION                                                                             \
    (PWR_CR4_SRAM3PDS10) /*!< SRAM3 page 10 (64 KB) retention in Stop mode (Stop 0, 1, 2, 3)  */
#define LL_PWR_SRAM3_STOP_PAGE11_RETENTION                                                                             \
    (PWR_CR4_SRAM3PDS11) /*!< SRAM3 page 11 (64 KB) retention in Stop mode (Stop 0, 1, 2, 3)  */
#define LL_PWR_SRAM3_STOP_PAGE12_RETENTION                                                                             \
    (PWR_CR4_SRAM3PDS12) /*!< SRAM3 page 12 (64 KB) retention in Stop mode (Stop 0, 1, 2, 3)  */
#define LL_PWR_SRAM3_STOP_PAGE13_RETENTION                                                                             \
    (PWR_CR4_SRAM3PDS13) /*!< SRAM3 page 13 (64 KB) retention in Stop mode (Stop 0, 1, 2, 3)  */
...
#define LL_PWR_SRAM3_STOP_1_8_RETENTION                                                                                \
    (PWR_CR2_SRAM3PDS1 | PWR_CR2_SRAM3PDS2 | PWR_CR2_SRAM3PDS3 | PWR_CR2_SRAM3PDS4 | PWR_CR2_SRAM3PDS5 |               \
     PWR_CR2_SRAM3PDS6 | PWR_CR2_SRAM3PDS7 |                                                                           \
     PWR_CR2_SRAM3PDS8) /*!< SRAM3 pages (1 to 8) retention in Stop modes (Stop 0, 1, 2, 3)  */
#if defined(PWR_CR4_SRAM3PDS9)
#define LL_PWR_SRAM3_STOP_9_13_RETENTION                                                                               \
    (PWR_CR4_SRAM3PDS9 | PWR_CR4_SRAM3PDS10 | PWR_CR4_SRAM3PDS11 | PWR_CR4_SRAM3PDS12 |                                \
     PWR_CR4_SRAM3PDS13) /*!< SRAM3 pages (9 to 13) retention in Stop modes (Stop 0, 1, 2, 3) */
#endif                   /* defined (PWR_CR4_SRAM3PDS9) */
/**
 * @}
 */
...
#define LL_PWR_SRAM5_STOP_PAGE1_RETENTION                                                                              \
    (PWR_CR4_SRAM5PDS1) /*!< SRAM5 page 1 (64 KB) retention in Stop mode (Stop 0, 1, 2, 3)   */
#define LL_PWR_SRAM5_STOP_PAGE2_RETENTION                                                                              \
    (PWR_CR4_SRAM5PDS2) /*!< SRAM5 page 2 (64 KB) retention in Stop mode (Stop 0, 1, 2, 3)   */
#define LL_PWR_SRAM5_STOP_PAGE3_RETENTION                                                                              \
    (PWR_CR4_SRAM5PDS3) /*!< SRAM5 page 3 (64 KB) retention in Stop mode (Stop 0, 1, 2, 3)   */
#define LL_PWR_SRAM5_STOP_PAGE4_RETENTION                                                                              \
    (PWR_CR4_SRAM5PDS4) /*!< SRAM5 page 4 (64 KB) retention in Stop mode (Stop 0, 1, 2, 3)   */
#define LL_PWR_SRAM5_STOP_PAGE5_RETENTION                                                                              \
    (PWR_CR4_SRAM5PDS5) /*!< SRAM5 page 5 (64 KB) retention in Stop mode (Stop 0, 1, 2, 3)   */
#define LL_PWR_SRAM5_STOP_PAGE6_RETENTION                                                                              \
    (PWR_CR4_SRAM5PDS6) /*!< SRAM5 page 6 (64 KB) retention in Stop mode (Stop 0, 1, 2, 3)   */
#define LL_PWR_SRAM5_STOP_PAGE7_RETENTION                                                                              \
    (PWR_CR4_SRAM5PDS7) /*!< SRAM5 page 7 (64 KB) retention in Stop mode (Stop 0, 1, 2, 3)   */
#define LL_PWR_SRAM5_STOP_PAGE8_RETENTION                                                                              \
    (PWR_CR4_SRAM5PDS8) /*!< SRAM5 page 8 (64 KB) retention in Stop mode (Stop 0, 1, 2, 3)   */
#define LL_PWR_SRAM5_STOP_PAGE9_RETENTION                                                                              \
    (PWR_CR4_SRAM5PDS9) /*!< SRAM5 page 4 (64 KB) retention in Stop mode (Stop 0, 1, 2, 3)   */
#define LL_PWR_SRAM5_STOP_PAGE10_RETENTION                                                                             \
    (PWR_CR4_SRAM5PDS10) /*!< SRAM5 page 5 (64 KB) retention in Stop mode (Stop 0, 1, 2, 3)   */
#define LL_PWR_SRAM5_STOP_PAGE11_RETENTION                                                                             \
    (PWR_CR4_SRAM5PDS11) /*!< SRAM5 page 6 (64 KB) retention in Stop mode (Stop 0, 1, 2, 3)   */
#define LL_PWR_SRAM5_STOP_PAGE12_RETENTION                                                                             \
    (PWR_CR4_SRAM5PDS12) /*!< SRAM5 page 7 (64 KB) retention in Stop mode (Stop 0, 1, 2, 3)   */
#define LL_PWR_SRAM5_STOP_PAGE13_RETENTION                                                                             \
    (PWR_CR4_SRAM5PDS13) /*!< SRAM5 page 8 (64 KB) retention in Stop mode (Stop 0, 1, 2, 3)   */
#define LL_PWR_SRAM5_STOP_FULL_RETENTION                                                                               \
    (PWR_CR4_SRAM5PDS1 | PWR_CR4_SRAM5PDS2 | PWR_CR4_SRAM5PDS3 | PWR_CR4_SRAM5PDS4 | PWR_CR4_SRAM5PDS5 |               \
     ...
     PWR_CR4_SRAM5PDS11 | PWR_CR4_SRAM5PDS12 |                                                                         \
...
#define LL_PWR_SRAM6_STOP_PAGE1_RETENTION                                                                              \
    (PWR_CR5_SRAM6PDS1) /*!< SRAM6 page 1 (64 KB) retention in Stop mode (Stop 0, 1, 2, 3)   */
#define LL_PWR_SRAM6_STOP_PAGE2_RETENTION                                                                              \
    (PWR_CR5_SRAM6PDS2) /*!< SRAM6 page 2 (64 KB) retention in Stop mode (Stop 0, 1, 2, 3)   */
#define LL_PWR_SRAM6_STOP_PAGE3_RETENTION                                                                              \
    (PWR_CR5_SRAM6PDS3) /*!< SRAM6 page 3 (64 KB) retention in Stop mode (Stop 0, 1, 2, 3)   */
#define LL_PWR_SRAM6_STOP_PAGE4_RETENTION                                                                              \
    (PWR_CR5_SRAM6PDS4) /*!< SRAM6 page 4 (64 KB) retention in Stop mode (Stop 0, 1, 2, 3)   */
#define LL_PWR_SRAM6_STOP_PAGE5_RETENTION                                                                              \
    (PWR_CR5_SRAM6PDS5) /*!< SRAM6 page 5 (64 KB) retention in Stop mode (Stop 0, 1, 2, 3)   */
#define LL_PWR_SRAM6_STOP_PAGE6_RETENTION                                                                              \
    (PWR_CR5_SRAM6PDS6) /*!< SRAM6 page 6 (64 KB) retention in Stop mode (Stop 0, 1, 2, 3)   */
#define LL_PWR_SRAM6_STOP_PAGE7_RETENTION                                                                              \
    (PWR_CR5_SRAM6PDS7) /*!< SRAM6 page 7 (64 KB) retention in Stop mode (Stop 0, 1, 2, 3)   */
#define LL_PWR_SRAM6_STOP_PAGE8_RETENTION                                                                              \
    (PWR_CR5_SRAM6PDS8) /*!< SRAM6 page 8 (64 KB) retention in Stop mode (Stop 0, 1, 2, 3)   */
#define LL_PWR_SRAM6_STOP_FULL_RETENTION                                                                               \
    (PWR_CR5_SRAM6PDS1 | PWR_CR5_SRAM6PDS2 | PWR_CR5_SRAM6PDS3 | PWR_CR5_SRAM6PDS4 | PWR_CR5_SRAM6PDS5 |               \
     PWR_CR5_SRAM6PDS6 | PWR_CR5_SRAM6PDS7 |                                                                           \
...
#define LL_PWR_ICACHERAM_STOP_FULL_RETENTION                                                                           \
    PWR_CR2_ICRAMPDS /*!< ICACHE SRAM retention in Stop mode (Stop 0, 1, 2)    */
/**
 * @}
 */
...
#define LL_PWR_DCACHE1RAM_STOP_FULL_RETENTION                                                                          \
    PWR_CR2_DC1RAMPDS /*!< DCACHE1 SRAM retention in Stop mode (Stop 0, 1, 2)    */
    /**
     * @}
     */
...
#define LL_PWR_DCACHE2RAM_STOP_FULL_RETENTION                                                                          \
    PWR_CR2_DC2RAMPDS /*!< DCACHE2 SRAM retention in Stop mode (Stop 0, 1, 2)    */
/**
 * @}
 */
...
#define LL_PWR_DMA2DRAM_STOP_FULL_RETENTION                                                                            \
    PWR_CR2_DMA2DRAMPDS /*!< DMA2D SRAM retention in Stop mode (Stop 0, 1, 2)    */
/**
 * @}
 */
...
#define LL_PWR_PERIPHRAM_STOP_FULL_RETENTION                                                                           \
    PWR_CR2_PRAMPDS /*!< FMAC, FDCAN and USB SRAM retention in Stop mode (Stop 0, 1, 2)    */
/**
 * @}
 */
...
#define LL_PWR_GRAPHICPERIPHRAM_STOP_NO_RETENTION                                                                      \
    0U /*!< Graphic peripherals (LTDC, GFXMMU) SRAM no retention in Stop mode (Stop 0, 1, 2) */
#define LL_PWR_GRAPHICPERIPHRAM_STOP_FULL_RETENTION                                                                    \
    PWR_CR2_GPRAMPDS /*!< Graphic peripherals (LTDC, GFXMMU) SRAM retention in Stop mode (Stop 0, 1, 2)    */
/**
 * @}
 */
...
#define LL_PWR_SRD_STOP_MODE                                                                                           \
    0U /*!< SmartRun domain AHB3 and APB3 clocks disabled by default in Stop mode (Stop 0, 1, 2) */
#define LL_PWR_SRD_RUN_MODE                                                                                            \
    PWR_CR2_SRDRUN /*!< SmartRun domain AHB3 and APB3 clocks kept enabled in Stop mode (Stop 0, 1, 2)        */
/**
 * @}
 */
...
#define LL_PWR_ReadReg(__REG__) READ_REG(PWR->__REG__)
    ...
    __STATIC_INLINE void LL_PWR_SetSRAM2StopRetention(uint32_t SRAM2PageRetention)
    {
        MODIFY_REG(PWR->CR2, LL_PWR_SRAM2_STOP_FULL_RETENTION,
                   ((~SRAM2PageRetention) & LL_PWR_SRAM2_STOP_FULL_RETENTION));
    }
    ...
    {
        MODIFY_REG(PWR->CR2, LL_PWR_SRAM4_STOP_FULL_RETENTION,
                   ((~SRAM4PageRetention) & LL_PWR_SRAM4_STOP_FULL_RETENTION));
    }
    ...
    {
        MODIFY_REG(PWR->CR4, LL_PWR_SRAM5_STOP_FULL_RETENTION,
                   ((~SRAM5PageRetention) & LL_PWR_SRAM5_STOP_FULL_RETENTION));
    }
    ...
    {
        MODIFY_REG(PWR->CR5, LL_PWR_SRAM6_STOP_FULL_RETENTION,
                   ((~SRAM6PageRetention) & LL_PWR_SRAM6_STOP_FULL_RETENTION));
    }
