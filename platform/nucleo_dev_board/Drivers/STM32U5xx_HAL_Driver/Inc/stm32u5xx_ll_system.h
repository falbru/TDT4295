...
#define LL_FLASH_PDKEY1_2                                                                                              \
    0xFAFBFCFDU /*!< Flash Bank1 power down key2: used with FLASH_PDKEY1                                               \
                 to unlock the RUN_PD bit in FLASH_ACR */

#define LL_FLASH_PDKEY2_1 0x40516273U /*!< Flash Bank2 power down key1 */
#define LL_FLASH_PDKEY2_2                                                                                              \
    0xAFBFCFDFU /*!< Flash Bank2 power down key2: used with FLASH_PDKEY2_1                                             \
                 to unlock the RUN_PD bit in FLASH_ACR */
/**
 * @}
 */
 ...
 * @{
 */
#define LL_SYSCFG_VDD_CELL_CODE                                                                                        \
    0U /*VDD I/Os code from the cell                                                                                   \
        (available in the SYSCFG_CCVR)*/
#define LL_SYSCFG_VDD_REGISTER_CODE                                                                                    \
    SYSCFG_CCCSR_CS1 /*VDD I/Os code from the SYSCFG compensation                                                      \
 ...
 * @{
 */
#define LL_SYSCFG_VDDIO2_CELL_CODE                                                                                     \
    0U /*VDDIO2 I/Os code from the cell                                                                                \
        (available in the SYSCFG_CCVR)*/
 ...
 * @{
 */
#define LL_SYSCFG_VDDHSPI_CELL_CODE                                                                                    \
    0U /*VDD HSPI I/Os code from the cell                                                                              \
       (available in the SYSCFG_CCVR)*/
#define LL_SYSCFG_VDDHSPI_REGISTER_CODE                                                                                \
    SYSCFG_CCCSR_CS3 /*VDD HSPI I/Os code from the SYSCFG compensation                                                 \
                     cell code register (SYSCFG_CCCR)*/
/**
 * @}
 */
...
#define LL_SYSCFG_HSPI_CAPACITANCE_1_DIV_3                                                                             \
    SYSCFG_CFGR1_ENDCAP_0 /*!< Decoupling with 1/3 of capacitance value on HSPI supply */
#define LL_SYSCFG_HSPI_CAPACITANCE_2_DIV_3                                                                             \
    SYSCFG_CFGR1_ENDCAP_1 /*!< Decoupling with 2/3 of capacitance value on HSPI supply */
#define LL_SYSCFG_HSPI_CAPACITANCE_FULL                                                                                \
    SYSCFG_CFGR1_ENDCAP /*!< Decoupling with full capacitance value on HSPI supply */
/**
 * @}
 */
...
#define LL_SYSCFG_TIMBREAK_SRAM_ECC_LOCK                                                                               \
    SYSCFG_CFGR2_SPL /*!< Enables and locks the SRAM ECC double error signal                                           \
                          with Break Input of TIM1/8/15/16/17 */
 ...
 * @{
 */
#define LL_SYSCFG_OTGHSPHY_CLK_16MHZ                                                                                   \
    (SYSCFG_OTGHSPHYCR_CLKSEL_0 | SYSCFG_OTGHSPHYCR_CLKSEL_1)       /*!< Reference clock freqeuncy is 16 Mhz */
#define LL_SYSCFG_OTGHSPHY_CLK_19_2MHZ (SYSCFG_OTGHSPHYCR_CLKSEL_3) /*!< Reference clock freqeuncy is 19.2 Mhz */
#define LL_SYSCFG_OTGHSPHY_CLK_20MHZ                                                                                   \
    (SYSCFG_OTGHSPHYCR_CLKSEL_0 | SYSCFG_OTGHSPHYCR_CLKSEL_3) /*!< Reference clock freqeuncy is 20 Mhz */
#define LL_SYSCFG_OTGHSPHY_CLK_24MHZ                                                                                   \
    (SYSCFG_OTGHSPHYCR_CLKSEL_1 | SYSCFG_OTGHSPHYCR_CLKSEL_3) /*!< Reference clock freqeuncy is 24 Mhz */
#define LL_SYSCFG_OTGHSPHY_CLK_26MHZ                                                                                   \
    (SYSCFG_OTGHSPHYCR_CLKSEL_1 | SYSCFG_OTGHSPHYCR_CLKSEL_2 |                                                         \
     SYSCFG_OTGHSPHYCR_CLKSEL_3) /*!< Reference clock freqeuncy is 26 Mhz */
#define LL_SYSCFG_OTGHSPHY_CLK_32MHZ                                                                                   \
...
#define LL_SYSCFG_OTGHSPHY_SQUELCH_0PERCENT                                                                            \
...
/** @defgroup SYSTEM_LL_OTG_TRANSMITTER_PREEMPHASIS_CURRENT SYSCFG OTG High-speed (HS) transmitter preemphasis current
 * control
 * @{
 */
#define LL_SYSCFG_OTGHSPHY_PREEMP_DISABLED 0x00000000U /*!< HS transmitter preemphasis circuit disabled */
#define LL_SYSCFG_OTGHSPHY_PREEMP_1X                                                                                   \
    SYSCFG_OTGHSPHYTUNER2_TXPREEMPAMPTUNE_0 /*!< HS transmitter preemphasis circuit sources 1x preemphasis current */
#define LL_SYSCFG_OTGHSPHY_PREEMP_2X                                                                                   \
    SYSCFG_OTGHSPHYTUNER2_TXPREEMPAMPTUNE_1 /*!< HS transmitter preemphasis circuit sources 2x preemphasis current */
#define LL_SYSCFG_OTGHSPHY_PREEMP_3X                                                                                   \
...
#define LL_SYSCFG_VTOR_NSEC                                                                                            \
    SYSCFG_CNSLCKR_LOCKNSVTOR /*!< Non-secure VTOR lock (privileged secure or non-secure only) */
...
#define LL_SYSCFG_VTOR_AIRCR_SEC                                                                                       \
    (SYSCFG_CSLCKR_LOCKSVTAIRCR << 16U) /*!< VTOR_S and AIRCR lock (privileged secure code only) */
#define LL_SYSCFG_LOCK_ALL                                                                                             \
    (LL_SYSCFG_MPU_NSEC | LL_SYSCFG_VTOR_NSEC | LL_SYSCFG_SAU | LL_SYSCFG_MPU_SEC |                                    \
...
#define LL_DBGMCU_APB2_GRP1_TIM1_STOP                                                                                  \
    DBGMCU_APB2FZR_DBG_TIM1_STOP /*!< The counter clock of TIM1 is stopped when the core is halted*/
#define LL_DBGMCU_APB2_GRP1_TIM8_STOP                                                                                  \
    DBGMCU_APB2FZR_DBG_TIM8_STOP /*!< The counter clock of TIM8 is stopped when the core is halted*/
#define LL_DBGMCU_APB2_GRP1_TIM15_STOP                                                                                 \
    DBGMCU_APB2FZR_DBG_TIM15_STOP /*!< The counter clock of TIM15 is stopped when the core is halted*/
#define LL_DBGMCU_APB2_GRP1_TIM16_STOP                                                                                 \
    DBGMCU_APB2FZR_DBG_TIM16_STOP /*!< The counter clock of TIM16 is stopped when the core is halted*/
#define LL_DBGMCU_APB2_GRP1_TIM17_STOP                                                                                 \
    DBGMCU_APB2FZR_DBG_TIM17_STOP /*!< The counter clock of TIM17 is stopped when the core is halted*/
/**
 * @}
 */
...
#define LL_DBGMCU_APB3_GRP1_I2C3_STOP                                                                                  \
    DBGMCU_APB3FZR_DBG_I2C3_STOP /*!< The counter clock of I2C3 is stopped when the core is halted*/
#define LL_DBGMCU_APB3_GRP1_LPTIM1_STOP                                                                                \
    DBGMCU_APB3FZR_DBG_LPTIM1_STOP /*!< The counter clock of LPTIM1 is stopped when the core is halted*/
#define LL_DBGMCU_APB3_GRP1_LPTIM3_STOP                                                                                \
    DBGMCU_APB3FZR_DBG_LPTIM3_STOP /*!< The counter clock of LPTIM3 is stopped when the core is halted*/
#define LL_DBGMCU_APB3_GRP1_LPTIM4_STOP                                                                                \
    DBGMCU_APB3FZR_DBG_LPTIM4_STOP /*!< The counter clock of LPTIM4 is stopped when the core is halted*/
#define LL_DBGMCU_APB3_GRP1_RTC_STOP                                                                                   \
    DBGMCU_APB3FZR_DBG_RTC_STOP /*!< The counter clock of RTC is stopped when the core is halted*/
/**
 * @}
 */
 ...
 * @{
 */
#define LL_DBGMCU_AHB1_GRP1_GPDMA0_STOP                                                                                \
    DBGMCU_AHB1FZR_DBG_GPDMA0_STOP /*!< The counter clock of GPDMA0 is stopped when the core is halted*/
#define LL_DBGMCU_AHB1_GRP1_GPDMA1_STOP                                                                                \
    DBGMCU_AHB1FZR_DBG_GPDMA1_STOP /*!< The counter clock of GPDMA1 is stopped when the core is halted*/
#define LL_DBGMCU_AHB1_GRP1_GPDMA2_STOP                                                                                \
    DBGMCU_AHB1FZR_DBG_GPDMA2_STOP /*!< The counter clock of GPDMA2 is stopped when the core is halted*/
#define LL_DBGMCU_AHB1_GRP1_GPDMA3_STOP                                                                                \
    DBGMCU_AHB1FZR_DBG_GPDMA3_STOP /*!< The counter clock of GPDMA3 is stopped when the core is halted*/
#define LL_DBGMCU_AHB1_GRP1_GPDMA4_STOP                                                                                \
    DBGMCU_AHB1FZR_DBG_GPDMA4_STOP /*!< The counter clock of GPDMA4 is stopped when the core is halted*/
#define LL_DBGMCU_AHB1_GRP1_GPDMA5_STOP                                                                                \
    DBGMCU_AHB1FZR_DBG_GPDMA5_STOP /*!< The counter clock of GPDMA5 is stopped when the core is halted*/
#define LL_DBGMCU_AHB1_GRP1_GPDMA6_STOP                                                                                \
    DBGMCU_AHB1FZR_DBG_GPDMA6_STOP /*!< The counter clock of GPDMA6 is stopped when the core is halted*/
#define LL_DBGMCU_AHB1_GRP1_GPDMA7_STOP                                                                                \
    DBGMCU_AHB1FZR_DBG_GPDMA7_STOP /*!< The counter clock of GPDMA7 is stopped when the core is halted*/
#define LL_DBGMCU_AHB1_GRP1_GPDMA8_STOP                                                                                \
    DBGMCU_AHB1FZR_DBG_GPDMA8_STOP /*!< The counter clock of GPDMA8 is stopped when the core is halted*/
#define LL_DBGMCU_AHB1_GRP1_GPDMA9_STOP                                                                                \
    DBGMCU_AHB1FZR_DBG_GPDMA9_STOP /*!< The counter clock of GPDMA9 is stopped when the core is halted*/
#define LL_DBGMCU_AHB1_GRP1_GPDMA10_STOP                                                                               \
    DBGMCU_AHB1FZR_DBG_GPDMA10_STOP /*!< The counter clock of GPDMA10 is stopped when the core is halted*/
#define LL_DBGMCU_AHB1_GRP1_GPDMA11_STOP                                                                               \
    DBGMCU_AHB1FZR_DBG_GPDMA11_STOP /*!< The counter clock of GPDMA11 is stopped when the core is halted*/
#define LL_DBGMCU_AHB1_GRP1_GPDMA12_STOP                                                                               \
    DBGMCU_AHB1FZR_DBG_GPDMA12_STOP /*!< The counter clock of GPDMA12 is stopped when the core is halted*/
#define LL_DBGMCU_AHB1_GRP1_GPDMA13_STOP                                                                               \
    DBGMCU_AHB1FZR_DBG_GPDMA13_STOP /*!< The counter clock of GPDMA13 is stopped when the core is halted*/
#define LL_DBGMCU_AHB1_GRP1_GPDMA14_STOP                                                                               \
    DBGMCU_AHB1FZR_DBG_GPDMA14_STOP /*!< The counter clock of GPDMA14 is stopped when the core is halted*/
#define LL_DBGMCU_AHB1_GRP1_GPDMA15_STOP                                                                               \
    DBGMCU_AHB1FZR_DBG_GPDMA15_STOP /*!< The counter clock of GPDMA15 is stopped when the core is halted*/
/**
 * @}
 */
 ...
 * @{
 */
#define LL_DBGMCU_AHB3_GRP1_LPDMA0_STOP                                                                                \
    DBGMCU_AHB3FZR_DBG_LPDMA0_STOP /*!< The counter clock of LPDMA0 is stopped when the core is halted*/
#define LL_DBGMCU_AHB3_GRP1_LPDMA1_STOP                                                                                \
    DBGMCU_AHB3FZR_DBG_LPDMA1_STOP /*!< The counter clock of LPDMA1 is stopped when the core is halted*/
#define LL_DBGMCU_AHB3_GRP1_LPDMA2_STOP                                                                                \
    DBGMCU_AHB3FZR_DBG_LPDMA2_STOP /*!< The counter clock of LPDMA2 is stopped when the core is halted*/
#define LL_DBGMCU_AHB3_GRP1_LPDMA3_STOP                                                                                \
    DBGMCU_AHB3FZR_DBG_LPDMA3_STOP /*!< The counter clock of LPDMA3 is stopped when the core is halted*/
    /**
     * @}
     */
...
#define LL_FLASH_LATENCY_15 FLASH_ACR_LATENCY_15WS /*!< FLASH fifteen wait states */
     ...
     *   @arg LL_SYSCFG_VDD_REGISTER_CODE: Selected Code is from the SYSCFG compensation cell code register
     * (SYSCFG_CCCR)
     */
