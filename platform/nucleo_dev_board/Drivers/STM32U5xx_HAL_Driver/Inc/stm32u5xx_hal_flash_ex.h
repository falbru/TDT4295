...
#include "stm32u5xx_hal_def.h"
    ...
    typedef struct
    {
        ...
        uint32_t BBAttributes_array[FLASH_BLOCKBASED_NB_REG]; /*!< Each bit specifies the block-based attribute
                                                                 configuration of a page: 0 means page non-protected, 1
                                                                 means page protected. Protection (secure or privilege)
...
#define FLASH_NSPRIV_DENIED                                                                                            \
    FLASH_PRIVCFGR_NSPRIV /*!< access to non-secure Flash registers is denied                                          \
