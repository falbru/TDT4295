...
#define EXC_INTEGRITY_SIGNATURE                                                                                        \
    ...
    __NO_RETURN __STATIC_INLINE void __SW_SystemReset(void)
    {
        ...
        SCB->AIRCR =
            (uint32_t)((0x5FAUL << SCB_AIRCR_VECTKEY_Pos) |
                       (SCB->AIRCR & SCB_AIRCR_BFHFNMINS_Msk) | /* Keep BFHFNMINS unchanged. Use this Reset function in
                                                                   case your case need to keep it */
    ...
    /**
      ...
      for the specified device specific interrupt.
      \param [in]      IRQn  Device specific interrupt number.
      \return             0  Interrupt status is not pending.
      \return             1  Interrupt status is pending.
      \note    IRQn must not be negative.
